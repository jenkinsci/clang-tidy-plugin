...
public class ClangtidyResult implements Serializable {
    ...
    public Object getDynamic(final String link, final StaplerRequest request,
        ...
        if (link.equals("source.all")) {
            ...
            Map<Integer, ClangtidyWorkspaceFile> agregateMap
                    = getClangtidySourceContainer().getInternalMap();

            if (agregateMap != null) {
                ClangtidyWorkspaceFile vClangtidyWorkspaceFile = agregateMap.get(
    ...
    public int getNumberErrorsAccordingConfiguration(
        ...
        ClangtidyStatistics prev = (previousResult != null)
     ...
     */
    public Collection<ClangtidyWorkspaceFile> diffCurrentAndPrevious(
        ...
        List<ClangtidyWorkspaceFile> curValues
                = new ArrayList<ClangtidyWorkspaceFile>(cur.getInternalMap().values());
    ...
    /**
     * Convert legacy data in format of clangtidy plugin version 1.14
    ...
    private ClangtidySourceContainer lazyLoadSourceContainer() {
        ...
        try {
            ...
            return new ClangtidySourceContainer(new HashMap<Integer,
                    ClangtidyWorkspaceFile>());
        }
    }
}
